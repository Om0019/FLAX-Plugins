...
var SIGNAL_PROBE_URL = 'https://api.themoviedb.org/3/movie/603/external_ids?api_key=***REDACTED***';
...
var AIOSTREAMS_PASSWORD = ((typeof process !== "undefined" && process.env ? process.env.AIOSTREAMS_PASSWORD : undefined));
...
function getStreams(tmdbId, mediaType, seasonNum, episodeNum) {
  var checks = [
    ...
    { name: 'tmdb key af3fa2..', fn: function () { return checkUrl('tmdb af3fa2..', 'https://api.themoviedb.org/3/movie/603/external_ids?api_key=***REDACTED***'); } },
    { name: 'tmdb key 439c47..', fn: function () { return checkUrl('tmdb 439c47..', 'https://api.themoviedb.org/3/movie/603/external_ids?api_key=***REDACTED***'); } },
